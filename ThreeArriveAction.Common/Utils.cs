...
namespace ThreeArriveAction.Common
{
    public class Utils
    {
        ...
        public static string OutPageList(int pageSize, int pageIndex, int totalCount, string linkUrl, int centSize)
        {
            ...
            string firstBtn = "<a href='javascript:" + ReplaceStr(linkUrl, pageId, (pageIndex - 1).ToString()) + "'>«上一页</a>";
            string lastBtn = "<a href='javascript:" + ReplaceStr(linkUrl, pageId, (pageIndex + 1).ToString()) + "'>下一页»</a>";
            string firstStr = "<a href='javascript:" + ReplaceStr(linkUrl, pageId, "1") + "'>1</a>";
            string lastStr = "<a href='javascript:" + ReplaceStr(linkUrl, pageId, pageCount.ToString()) + "'>" + pageCount.ToString() + "</a>";
            ...
            for (int i = firstNum; i <= lastNum; i++)
            {
                ...
                {
                    pageStr.Append("<a href='javascript:" + ReplaceStr(linkUrl, pageId, i.ToString()) + "'>" + i + "</a>");
                }
            }
