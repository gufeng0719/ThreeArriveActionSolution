...
{ /// <summary>
  ...
  /// </summary>
    public partial class wx_requst_BaseDataDAL
    {
        public wx_requst_BaseDataDAL()
        { }
        #region  BasicMethod
        ...
        public wx_requst_BaseDataModel GetModel(int id)
        {
            ...
            wx_requst_BaseDataModel model = new wx_requst_BaseDataModel();
        ...
        /// 得到一个对象实体
        /// </summary>
        public wx_requst_BaseDataModel DataRowToModel(DataRow row)
        {
            wx_requst_BaseDataModel model = new wx_requst_BaseDataModel();
            if (row != null)
            {
