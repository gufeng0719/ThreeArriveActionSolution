...
namespace ThreeArriveAction.DAL
{
	...
	/// </summary>
    public partial class wx_requestRuleContentDAL
    {
        public wx_requestRuleContentDAL()
		{}
		#region  BasicMethod
		...
		public wx_requestRuleContentModel GetModel(int id)
		{
            ...
            wx_requestRuleContentModel model = new wx_requestRuleContentModel();
		...
		/// 得到一个对象实体
		/// </summary>
		public wx_requestRuleContentModel DataRowToModel(DataRow row)
		{
            wx_requestRuleContentModel model = new wx_requestRuleContentModel();
			if (row != null)
			{
        ...
        {
            IList<wx_requestRuleContentModel> rcList = new List<wx_requestRuleContentModel>();
