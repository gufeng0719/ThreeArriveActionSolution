...
namespace ThreeArriveAction.DAL
{
	...
	/// </summary>
	public partial class wx_property_infoDAL
    {
        public wx_property_infoDAL()
        { }
        #region  BasicMethod
        ...
        public wx_property_info GetModel(int id)
        {
            ...
            wx_property_info model = new wx_property_info();
        ...
        /// 得到一个对象实体
        /// </summary>
        public wx_property_info DataRowToModel(DataRow row)
        {
            wx_property_info model = new wx_property_info();
            if (row != null)
            {
