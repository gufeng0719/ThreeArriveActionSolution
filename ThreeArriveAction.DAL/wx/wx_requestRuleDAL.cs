...
using ThreeArriveAction.Model;//Please add references
namespace ThreeArriveAction.DAL
{
    /// <summary>
    /// 数据访问类:wx_requestRule
    /// </summary>
    public partial class wx_requestRuleDAL
    {
        public wx_requestRuleDAL()
        { }
        #region  BasicMethod
        ...
        public wx_requestRuleModel GetModel(int id)
        {
            ...
            wx_requestRuleModel model = new wx_requestRuleModel();
        ...
        /// 得到一个对象实体
        /// </summary>
        public wx_requestRuleModel DataRowToModel(DataRow row)
        {
            wx_requestRuleModel model = new wx_requestRuleModel();
            if (row != null)
            {
        ...
        public wx_requestRuleModel GetSubscricModel(int wid)
        {
        ...
        /// <returns></returns>
        public wx_requestRuleModel GetTop1Model(int wid, string strWhere)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 id,wId,uId,ruleName,reqKeywords,reqestType,responseType,isDefault,modelFunctionName,modelFunctionId,seq,createDate,agentUrl,agentToken,isLikeSearch,extInt,extInt2,extStr,extStr2,extStr3,extStr4 from wx_requestRule ");
