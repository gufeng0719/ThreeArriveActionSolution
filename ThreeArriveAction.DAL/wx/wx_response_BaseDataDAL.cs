...
namespace ThreeArriveAction.DAL
{
	...
	/// </summary>
	public partial class wx_response_BaseDataDAL
    {
        public wx_response_BaseDataDAL()
        { }
        #region  BasicMethod
        ...
        public wx_response_BaseDataModel GetModel(int id)
        {
            ...
            wx_response_BaseDataModel model = new wx_response_BaseDataModel();
        ...
        /// 得到一个对象实体
        /// </summary>
        public wx_response_BaseDataModel DataRowToModel(DataRow row)
        {
            wx_response_BaseDataModel model = new wx_response_BaseDataModel();
            if (row != null)
            {
