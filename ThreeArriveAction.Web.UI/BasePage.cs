...
namespace ThreeArriveAction.Web.UI
{
    public partial class BasePage : System.Web.UI.Page
    {
        ...
        protected internal  siteconfig  config= new sys_configBLL().loadConfig();
        ...
        public BasePage()
        {
            ...
            {
                HttpContext.Current.Response.Redirect(config.webpath + "error.ashx?msg=" + Utils.UrlEncode(config.webclosereason));
                return;
            }
            ShowPage();
        }
