...
namespace ThreeArriveAction.BLL
{
	...
	/// 用户的微信基本表
	/// </summary>
	public partial class wx_userweixinBLL
    {
        private readonly wx_userweixinDAL dal = new  wx_userweixinDAL();
        public wx_userweixinBLL()
        { }
        #region  BasicMethod
        ...
        /// 增加一条数据
        /// </summary>
        public int Add(wx_userweixin model)
        {
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(wx_userweixin model)
        {
        ...
        /// 得到一个对象实体
        /// </summary>
        public wx_userweixin GetModel(int id)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<wx_userweixin> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<wx_userweixin> DataTableToList(DataTable dt)
        {
            List<wx_userweixin> modelList = new List<wx_userweixin>();
